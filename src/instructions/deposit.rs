...
pub struct DepositBuilder {
    ...
    minimum_lp_token_amount: Option<u64>,
...
impl DepositBuilder {
    ...
    #[inline(always)]
    pub fn token_amount(&mut self, token_amount: u64) -> &mut Self {
        self.token_amount = Some(token_amount);
        self
    }
    #[inline(always)]
    pub fn minimum_lp_token_amount(&mut self, minimum_lp_token_amount: u64) -> &mut Self {
        self.minimum_lp_token_amount = Some(minimum_lp_token_amount);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DepositInstructionArgs {
            token_amount: self.token_amount.clone().expect("token_amount is not set"),
            minimum_lp_token_amount: self
                .minimum_lp_token_amount
                .clone()
                .expect("minimum_lp_token_amount is not set"),
        };
...
impl<'a, 'b> DepositCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn token_amount(&mut self, token_amount: u64) -> &mut Self {
        self.instruction.token_amount = Some(token_amount);
        self
    }
    #[inline(always)]
    pub fn minimum_lp_token_amount(&mut self, minimum_lp_token_amount: u64) -> &mut Self {
        self.instruction.minimum_lp_token_amount = Some(minimum_lp_token_amount);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
    ...
    pub fn invoke_signed(
        ...
        let args = DepositInstructionArgs {
            token_amount: self
                ...
                .token_amount
                .clone()
                .expect("token_amount is not set"),
            minimum_lp_token_amount: self
                .instruction
                .minimum_lp_token_amount
                .clone()
