...
impl WithdrawStrategy {
    pub fn instruction(
        &self,
        args: WithdrawStrategyInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WithdrawStrategyInstructionData::new().try_to_vec().unwrap();
...
pub struct WithdrawStrategyInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawStrategyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for WithdrawStrategyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WithdrawStrategyInstructionArgs {
    pub amount: u64,
}

/// Instruction builder for `WithdrawStrategy`.
///
/// ### Accounts:
///
///   0. `[writable]` vault
...
pub struct WithdrawStrategyBuilder {
...
impl WithdrawStrategyBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = WithdrawStrategyInstructionArgs {
...
/// `withdraw_strategy` CPI accounts.
pub struct WithdrawStrategyCpiAccounts<'a, 'b> {
...
/// `withdraw_strategy` CPI instruction.
pub struct WithdrawStrategyCpi<'a, 'b> {
    ...
    pub __args: WithdrawStrategyInstructionArgs,
}

impl<'a, 'b> WithdrawStrategyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawStrategyCpiAccounts<'a, 'b>,
        args: WithdrawStrategyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawStrategy` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` vault
...
///   9. `[signer]` operator
#[derive(Clone, Debug)]
pub struct WithdrawStrategyCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawStrategyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawStrategyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawStrategyCpiBuilderInstruction {
            __program: program,
            vault: None,
            strategy: None,
            token_vault: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawStrategyCpi {
...
#[derive(Clone, Debug)]
struct WithdrawStrategyCpiBuilderInstruction<'a, 'b> {
